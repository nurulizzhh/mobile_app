...
final List<FavouriteMenuModel> favorit = [
  FavouriteMenuModel(
    kategori: 'Lunch',
...
final List<BreakfastMenuModel> breakfast = [
    BreakfastMenuModel(
      kategori: '',
      nama: '',
      kalori: '',
...
final List<LunchMenuModel> lunch = [
    LunchMenuModel(
      kategori: 'Lunch',
      nama: 'Tumis jamur tiram',
      bahan: '- 1 pak jamur tiram, suwir\n- 6 buah putren\n- 2 siung bawang putih cincang\n'
...
final List<DinnerMenuModel> dinner = [
    DinnerMenuModel(
      kategori: 'Dinner',
      nama: 'Kangkung telur puyuh',
      bahan: '- 1 ikat besar kangkung, petiki\n- 15 butir telur puyuh, rebus kupas\n'
...
final List<DessertMenuModel> dessert = [
    DessertMenuModel(
      kategori: 'Dessert',
      nama: 'Pudding chocolate',
      bahan: '- premix Puding Chocolate\n- air\n- whipcream\n- chocochips',
